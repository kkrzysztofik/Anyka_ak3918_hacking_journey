...
description: TypeScript and React 19 implementation specialist for the Anyka camera WebUI. Builds shadcn/ui components, TanStack Query hooks, ONVIF SOAP services, and Vite 7 bundles sized for embedded deployment (<10MB uncompressed).
tools: [read, edit, execute, search, web, github/*]
---
