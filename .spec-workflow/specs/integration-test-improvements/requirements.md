...
1. WHEN Profile S compliance is tested THEN the system SHALL validate every mandatory capability mandated by the Base Device Test Specification v25.06, Real Time Streaming Test Specification v24.12, Authentication Behavior Device Test Specification v19.06, Credential Device Test Specification v20.12, Security Configuration Device Test Specification v23.06, Event Handling Test Specification v21.12, and—where applicable—the PTZ Device Test Specification v24.12; coverage MUST include HTTP Digest and WS-UsernameToken authentication, credential lifecycle operations, WS-Discovery, device/network configuration, system date/time synchronization, RTSP/RTP streaming with metadata channels, conditional PTZ control for PTZ-capable devices, and event subscription/notification validation
2. WHEN Profile T compliance is tested THEN the system SHALL validate all mandatory capabilities defined in the Profiles Conformance Test Specification v21.12, Media Configuration Device Test Specification v24.06, Media2 Configuration Device Test Specification v25.06, Real Time Streaming using Media2 Device Test Specification v24.12, Imaging Test Specification v20.06, Event Handling Test Specification v21.12, Security Configuration Device Test Specification v23.06, and—when PTZ is supported—the PTZ Device Test Specification v24.12; coverage MUST include enhanced video streaming (H.265 and metadata), imaging controls, advanced eventing, and strengthened security requirements
