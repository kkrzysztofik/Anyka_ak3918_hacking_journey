---
name: devops
description: Use when managing cross-compilation, SD card deployment, CI/CD quality gates, coverage reporting, Docker builds, or diagnosing/fixing build failures across Rust, C, and TypeScript.
