...
int i_main_width = DEFAULT_MAIN_WIDTH;                                                             // Main channel resolution
int i_main_height = DEFAULT_MAIN_HEIGHT;
int i_sub_width = DEFAULT_SUB_WIDTH;                                                               // Sub channel resolution
int i_sub_height = DEFAULT_SUB_HEIGHT;
int i_main_kbps = DEFAULT_MAIN_KBPS;                                                               // Bitrate
int i_sub_kbps = DEFAULT_SUB_KBPS;
int i_main_fps = DEFAULT_MAIN_FPS;                                                                 // Framerate
...
int i_gop = DEFAULT_GOP;                                                                           // I-frame interval in seconds
int i_minqp = DEFAULT_MINQP;                                                                       // Compression ratio range
...
static int help_hint(void)                                                                          // Print help information based on option_long and ac_option_hint
{
	int i ;
	printf( "%s\n" , pc_prog_name ) ;
