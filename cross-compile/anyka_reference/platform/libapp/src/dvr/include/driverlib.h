...
#ifdef SNOWBIRDL   //[garbled encoding - original text unrecoverable]
...
{
	T_U32 start;		//[garbled encoding - original text unrecoverable]
	T_U32 cnt;		//[garbled encoding - original text unrecoverable]
}FAT_INFO, *PFAT_INFO;
