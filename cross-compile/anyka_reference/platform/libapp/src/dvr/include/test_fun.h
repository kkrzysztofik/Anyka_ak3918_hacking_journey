...

{
    ...
    T_U32 SectorSize; // sector size

    T_U32 ClusterSize; // cluster size

    T_U8 FatType; // FAT type
...

{
   ...
   T_U32 BufferSize; // buffer size

T_U32 FileSize; // file size
 ...
 * FUNCTION  Get the format type supported by the driver.
 * PARAM:      T_U8 DriverID : driver ID
                        T_U8 *SupportType : support type

 * RETURN:     AK_TRUE on success, AK_FALSE on failure
**************************************************************************/
 ...
 * FUNCTION  Get testing information for the driver.
 * PARAM:      T_U8 DriverID : driver ID
                        T_PDRIVERTESTINFO  pDriverTestInfo : pointer to driver test info
 ...
 * FUNCTION  Get testing information for the file.
 * PARAM:      T_U32 file : file handle
                        T_PFILETESTINFO FileTestInfo : pointer to file test info
 ...
 * FUNCTION  Get directory FDT information.
 * PARAM:      T_U32 FolderHandle : folder handle
                        T_U32 *TolFdt : total FDT
                        T_U32 *SeriousFdt : serious FDT
 * RETURN:     AK_TRUE on success, AK_FALSE on failure
**************************************************************************/
 ...
 * FUNCTION  Get the last updated cluster.
 * PARAM:      T_U32 FileHandle : file handle
 * RETURN:     last updated cluster ID
**************************************************************************/
 ...
 * FUNCTION  Get the next cluster for the driver.
 * PARAM:      T_U32 DriverID : driver ID
                        T_U32 CurCluster : current cluster ID
 ...
 * FUNCTION  Get the position of a cluster on the driver.
 * PARAM:      T_U32 DriverID : driver ID
                        T_U32 CurCluster : current cluster ID
                        T_U32 *SectorAddr: sector address
                        T_U32 *SectorOff : sector offset
 * RETURN:    AK_TRUE on success, AK_FALSE on failure
**************************************************************************/
 ...
 * FUNCTION  Get FAT buffer information for the file.
 * PARAM:      T_PFILE FileHandle : file handle
 * RETURN:     pointer to FAT buffer info
 example:
    t_u8 *data; // data
    NewFatInfo.cnt; // count
    while (*data)
    {
 ...
 * FUNCTION  Get FAT buffer information for the driver.
 * PARAM:      T_U32 DriverID : driver ID
                        PFAT_INFO FatInfo : pointer to FAT info
                        T_U8 flag : flag
 * RETURN:    FAT buffer size
**************************************************************************/
 ...
 * FUNCTION  Get FAT sector size for the driver.
 * PARAM:      T_U32 DriverID : driver ID
                        T_U32 *FatNum : FAT number

 * RETURN:    FAT sector size
**************************************************************************/
 ...
 * FUNCTION  Get FAT information for the driver.
 * PARAM:      T_U32 DriverID : driver ID
                        T_U32 addr: address
                        T_U32 size: size
                        T_U8 * FatBuf: FAT buffer
 * RETURN:     AK_TRUE on success, AK_FALSE on failure
**************************************************************************/
