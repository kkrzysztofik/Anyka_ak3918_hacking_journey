...
/* Standard display characters, including "Week Monday-Sunday, Year Month Day" */
/* GB2312, Chinese character area-position code encoding:
    Xing (Star/Week) 4839 0xd0c7, Qi (Period) 3858 0xc6da
    Yi (One) 5027 0xd2bb, Er (Two) 2294 0xb6fe, San (Three) 4093 0xc8fd, Si (Four) 4336 0xcbc4
    Wu (Five) 4669 0xcee5, Liu (Six) 3389 0xc1f9, Tian (Day/Sky) 4476 0xccec
    Nian (Year) 3674 0xc4ea, Yue (Month) 5234 0xd4c2, Ri (Day) 4053 0xc8d5
