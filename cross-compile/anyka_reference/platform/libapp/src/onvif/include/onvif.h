...
/**
 * Get the NkUtils library version number.\n
 * The library implementation directly returns the value of the @ref NK_UTILS_REVISION macro definition internally.\n
 * Since the library is already confirmed at the time of release, this can be called after library loading to determine whether the returned result matches the @ref NK_UTILS_REVISION definition in the header file and whether the header file matches the binary library file.\n
 * Using this method effectively prevents potential issues caused by mismatches between header files and binary library files.
 *
 * @return
 * 	Returns the NkUtils library version number, consistent with @ref NK_UTILS_REVISION.\n
 *
 */
extern unsigned int
