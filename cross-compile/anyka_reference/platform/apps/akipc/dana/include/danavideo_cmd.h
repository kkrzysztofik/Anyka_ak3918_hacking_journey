...
typedef enum danavideo_osd_date_format_e_ {
    ...
    DANAVIDEO_OSD_DATE_FORMAT_YYYY_MM_DD_CH,    // YYYY-Year-MM-Month-DD-Day (Chinese locale)
    DANAVIDEO_OSD_DATE_FORMAT_MM_DD_YYYY_CH,    // MM-Month-DD-Day-YYYY-Year (Chinese locale)
    DANAVIDEO_OSD_DATE_FORMAT_DD_MM_YYYY,       // DD-MM-YYYY
    DANAVIDEO_OSD_DATE_FORMAT_DD_MM_YYYY_CH     // DD-Day-MM-Month-YYYY-Year (Chinese locale)
...
typedef enum danaicr_mode_type_e_ {
    DANA_ICR_MODE_COLOR = 1, // color
    DANA_ICR_MODE_BW    = 2, // black and white
    DANA_ICR_MODE_AUTO  = 3, // auto
} danaicr_mode_type_t;

typedef enum danasdc_status_type_e_ {
    DANA_SDC_STATUS_NO_SDC = 1,  //no SD card
    DANA_SDC_STATUS_NOMAL  = 2,  //normal working state
    DANA_SDC_STATUS_FORMAT = 3,  //formatting state
    DANA_SDC_STATUS_DAMAGE = 4,  //damaged state
...
//20170315
#if 0 //20170316, temporarily not provided
