...
/*
	REG_EXTENDED - extended pattern matching
	REG_ICASE    - case insensitive
	REG_NOSUB    - do not store match results
	REG_NEWLINE  - recognize newline characters
*/
/*
...
struct regloop {                                                                                    //structure for iteratively reading consecutive entries matching the same regex format
	regex_t regex_t_use ;
	char *pc_pattern;
	int i_flags;
