...
typedef struct
{
    ...
    // Note: the start address of m_szData must be 4-byte aligned
...
// This is the structure for APE szData; the platform layer must read the data in szData to use as audio decode parameters
