...
/* command define */
typedef enum {
	ISP_PARM_CODE = ISP_SENSOR + 1,	// ISP parameter code
	ISP_REGISTER,					// Register parameters
	ISP_RAW_IMG,					// One frame of RAW image data
	ISP_YUV_IMG,					// One frame of YUV image data
	ISP_ENCODE_IMG,					// One frame of encoded image data
