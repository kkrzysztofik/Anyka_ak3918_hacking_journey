...
#define COLOR_BACK_BLACK         40                                                                 // Background color definitions
...
#define COLOR_FRONT_BLACK        30                                                                 // Font color definitions
...
/* magic test macro, used to test whether the parameters passed to the interface are returned by this module */
