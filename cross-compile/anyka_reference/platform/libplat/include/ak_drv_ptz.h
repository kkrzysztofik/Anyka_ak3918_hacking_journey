...
/* Self-check steps */
enum sc_step {
	SC_CLKNONE = 0,	/* Not running */
	SC_CLKMAX,		/* Clockwise to limit */
	SC_ACLKMAX,		/* Anti-clockwise to limit */
	SC_CLKMID,		/* Clockwise to middle */
	SC_ACLKMID,		/* Anti-clockwise to middle */
};
