...
#define SOAP_MEDIA_GET_PROFILES                                                                                                                      \
  ...
  "<trt:GetProfiles/>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_MEDIA_GET_STREAM_URI                                                                                                                    \
  ...
  "</trt:StreamSetup>"                                                                                                                               \
  "</trt:GetStreamUri>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_MEDIA_CREATE_PROFILE                                                                                                                    \
  ...
  "</trt:CreateProfile>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_MEDIA_DELETE_PROFILE                                                                                                                    \
  ...
  "</trt:DeleteProfile>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_MEDIA_SET_VIDEO_SOURCE_CONFIG                                                                                                           \
  ...
  "</trt:SetVideoSourceConfiguration>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_MEDIA_SET_VIDEO_ENCODER_CONFIG                                                                                                          \
  ...
  "<tt:RateControl><tt:FrameRateLimit>30</tt:FrameRateLimit><tt:BitrateLimit>4096</"                                                                 \
  "tt:BitrateLimit></tt:RateControl>"                                                                                                                \
  "<tt:H264><tt:GovLength>50</tt:GovLength></tt:H264>"                                                                                               \
  "</trt:Configuration>"                                                                                                                             \
  "<trt:ForcePersistence>true</trt:ForcePersistence>"                                                                                                \
  "</trt:SetVideoEncoderConfiguration>" SOAP_ENVELOPE_FOOTER

/* GetMetadataConfigurations - Returns metadata configurations */
#define SOAP_MEDIA_GET_METADATA_CONFIGURATIONS                                                                                                       \
  SOAP_ENVELOPE_HEADER                                                                                                                               \
  "<trt:GetMetadataConfigurations/>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_MEDIA_SET_METADATA_CONFIGURATION                                                                                                        \
  ...
  "</trt:Configuration>"                                                                                                                             \
  "<trt:ForcePersistence>true</trt:ForcePersistence>"                                                                                                \
  "</trt:SetMetadataConfiguration>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_MEDIA_START_MULTICAST_STREAMING                                                                                                         \
  ...
  "<trt:ProfileToken>Profile1</trt:ProfileToken>"                                                                                                    \
  "</trt:StartMulticastStreaming>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_MEDIA_STOP_MULTICAST_STREAMING                                                                                                          \
  ...
  "<trt:ProfileToken>Profile1</trt:ProfileToken>"                                                                                                    \
  "</trt:StopMulticastStreaming>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_PTZ_GET_NODES                                                                                                                           \
  SOAP_ENVELOPE_HEADER                                                                                                                               \
  "<tptz:GetNodes/>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_PTZ_ABSOLUTE_MOVE                                                                                                                       \
  ...
  "</tptz:Speed>"                                                                                                                                    \
  "</tptz:AbsoluteMove>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_PTZ_GET_PRESETS                                                                                                                         \
  ...
  "<tptz:GetPresets>"                                                                                                                                \
  "<tptz:ProfileToken>ptz_profile_1</tptz:ProfileToken>"                                                                                             \
  "</tptz:GetPresets>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_PTZ_SET_PRESET                                                                                                                          \
  ...
  "</tptz:SetPreset>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_PTZ_GOTO_PRESET                                                                                                                         \
  ...
  "space=\"http://www.onvif.org/ver10/tptz/ZoomSpaces/ZoomGenericSpeedSpace\"/>"                                                                     \
  "</tptz:Speed>"                                                                                                                                    \
  "</tptz:GotoPreset>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_PTZ_REMOVE_PRESET                                                                                                                       \
  ...
  "</tptz:RemovePreset>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_PTZ_GET_NODE                                                                                                                            \
  ...
  "</tptz:GetNode>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_PTZ_GET_CONFIGURATION                                                                                                                   \
  ...
  "</tptz:GetConfiguration>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_PTZ_GET_STATUS                                                                                                                          \
  ...
  "<tptz:GetStatus>"                                                                                                                                 \
  "<tptz:ProfileToken>ptz_profile_1</tptz:ProfileToken>"                                                                                             \
  "</tptz:GetStatus>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_PTZ_GOTO_HOME_POSITION                                                                                                                  \
  ...
  "space=\"http://www.onvif.org/ver10/tptz/ZoomSpaces/ZoomGenericSpeedSpace\"/>"                                                                     \
  "</tptz:Speed>"                                                                                                                                    \
  "</tptz:GotoHomePosition>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_DEVICE_GET_DEVICE_INFORMATION                                                                                                           \
  SOAP_ENVELOPE_HEADER                                                                                                                               \
  "<tds:GetDeviceInformation/>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_DEVICE_GET_CAPABILITIES                                                                                                                 \
  ...
  "</tds:GetCapabilities>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_IMAGING_GET_IMAGING_SETTINGS                                                                                                            \
  ...
  "</timg:GetImagingSettings>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_IMAGING_SET_IMAGING_SETTINGS                                                                                                            \
  ...
  "</timg:SetImagingSettings>" SOAP_ENVELOPE_FOOTER
...
#define SOAP_INVALID_XML                                                                                                                             \
  ...
  "<s:Body>"                                                                                                                                         \
  "<trt:GetProfiles>" /* Missing closing tags */                                                                                                     \
  "</s:Body>"
...
#define SOAP_WRONG_OPERATION                                                                                                                         \
  SOAP_ENVELOPE_HEADER                                                                                                                               \
  "<trt:NonExistentOperation/>" SOAP_ENVELOPE_FOOTER
