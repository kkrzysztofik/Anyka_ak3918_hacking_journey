...
int main(int argc, char* argv[]) {
  ...
  const struct CMUnitTest tests[] = {
    ...
    cmocka_unit_test_setup_teardown(test_unit_http_metrics_null_handling, setup_http_metrics_tests,
                                    teardown_http_metrics_tests),
    cmocka_unit_test_setup_teardown(test_unit_http_metrics_connection_updates,
                                    setup_http_metrics_tests, teardown_http_metrics_tests),
    cmocka_unit_test_setup_teardown(test_unit_http_metrics_concurrency, setup_http_metrics_tests,
                                    teardown_http_metrics_tests),
    cmocka_unit_test_setup_teardown(test_unit_http_metrics_cpu_overhead, setup_http_metrics_tests,
                                    teardown_http_metrics_tests),
