...
static const char *valid_onvif_paths[] = {
...
static const char *valid_soap_actions[] = {
    "GetCapabilities",
...
static int is_string_in_array(const char *str, const char *array[]) {
...
int sanitize_string_input(const char *input, char *output, size_t output_size) {
    ...
    if (input_len >= output_size) return 0;
