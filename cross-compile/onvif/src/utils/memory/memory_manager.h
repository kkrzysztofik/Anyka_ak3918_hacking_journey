...
/* Essential macros */
#define ONVIF_MALLOC(size) \
  onvif_malloc((size), __FILE__, __LINE__, __FUNCTION__)
#define ONVIF_CALLOC(count, size) \
  onvif_calloc((count), (size), __FILE__, __LINE__, __FUNCTION__)
#define ONVIF_REALLOC(ptr, size) \
  onvif_realloc((ptr), (size), __FILE__, __LINE__, __FUNCTION__)
