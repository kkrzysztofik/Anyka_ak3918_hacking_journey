...
int error_context_init(error_context_t* context, const char* service_name, const char* action_name, const char* error_context);
...
void onvif_log_error_with_context(int error_code, const char* function, const char* file, int line, const char* message, ...);
