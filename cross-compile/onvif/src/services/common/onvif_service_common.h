 ...
 */
typedef int (*onvif_validation_callback_t)(const service_handler_config_t* config, const http_request_t* request, http_response_t* response,
 ...
 */
typedef int (*onvif_business_logic_callback_t)(const service_handler_config_t* config, const http_request_t* request, http_response_t* response,
                                               onvif_gsoap_context_t* gsoap_ctx, service_log_context_t* log_ctx, error_context_t* error_ctx,
                                               void* callback_data);
 ...
 */
typedef int (*onvif_post_process_callback_t)(http_response_t* response, service_log_context_t* log_ctx);
