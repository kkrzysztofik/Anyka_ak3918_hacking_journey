...
int onvif_imaging_get_settings(
    struct imaging_settings *settings); /**< Fetch current settings. */
int onvif_imaging_set_settings(
    const struct imaging_settings *settings); /**< Apply settings. */
int onvif_imaging_set_day_night_mode(
    enum day_night_mode mode); /**< Force day/night mode. */
int onvif_imaging_get_day_night_mode(
    void); /**< Query current forced/auto mode. */
int onvif_imaging_set_irled_mode(
    enum ir_led_mode mode);               /**< Set IR LED mode. */
int onvif_imaging_get_irled_status(void); /**< Get IR LED status/level. */
int onvif_imaging_set_flip_mirror(
    int flip, int mirror); /**< Configure image flip/mirror. */
int onvif_imaging_set_auto_config(
...
int onvif_imaging_handle_request(
    ...
    onvif_response_t *response); /**< Handle ONVIF imaging service requests. */
