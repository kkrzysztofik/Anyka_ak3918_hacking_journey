...
/**
 * @brief Cleanup HTTP response (free allocated memory)
 * @param http_resp HTTP response structure
 */
void http_response_cleanup(http_response_t *http_resp);

/* onvif_response_cleanup is now provided by utils/error/error_handling.h */
