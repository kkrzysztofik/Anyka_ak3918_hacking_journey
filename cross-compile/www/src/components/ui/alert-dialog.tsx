...
const AlertDialogHeader = ({
  ...
  <div
    ...
    data-testid={testId || 'alert-dialog-header'}
    {...props}
  />
);
...
const AlertDialogFooter = ({
  ...
  <div
    ...
    data-testid={testId || 'alert-dialog-footer'}
    {...props}
  />
);
...
>(({ className, 'data-testid': testId, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ...
    data-testid={testId || 'alert-dialog-title'}
    {...props}
  />
));
...
>(({ className, 'data-testid': testId, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ...
    data-testid={testId || 'alert-dialog-description'}
    {...props}
  />
));
...
>(({ className, 'data-testid': testId, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ...
    data-testid={testId || 'alert-dialog-action'}
    {...props}
  />
));
...
>(({ className, 'data-testid': testId, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    data-testid={testId || 'alert-dialog-cancel'}
    {...props}
  />
));
