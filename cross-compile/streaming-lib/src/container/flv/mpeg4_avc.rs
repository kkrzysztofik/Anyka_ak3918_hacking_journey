use {
    crate::container::define::h264_nal_type,
    crate::container::errors::Mpeg4AvcHevcError,
    crate::io::{bytes_reader::BytesReader, bytes_writer::BytesWriter},
    byteorder::BigEndian,
    bytes::BytesMut,
    std::vec::Vec,
};

use crate::codec::h264::sps::SpsParser;
use crate::container::errors::MpegErrorValue;
...
impl Mpeg4AvcProcessor {
    ...
    pub fn decoder_configuration_record_load(
        ...
        for i in 0..self.mpeg4_avc.nb_sps as usize {
            ...
            tracing::info!(
                profile = self.mpeg4_avc.profile,
                compatibility = self.mpeg4_avc.compatibility,
                level = self.mpeg4_avc.level,
                width = self.mpeg4_avc.width,
                height = self.mpeg4_avc.height,
                "mpeg4_avc_parsed"
            );
...
mod tests {
    use super::*;
    use crate::io::{bytes_reader::BytesReader, bytes_writer::BytesWriter};
    use bytes::BytesMut;
