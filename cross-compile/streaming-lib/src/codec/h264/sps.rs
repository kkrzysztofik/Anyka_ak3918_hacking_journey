use {
    crate::codec::errors::H264Error, crate::codec::utils, crate::io::bits_reader::BitsReader,
    crate::io::bytes_reader::BytesReader, bytes::BytesMut, std::vec::Vec,
};
...
mod tests {
    ...
    struct SpsBuilder {
        writer: crate::io::bits_writer::BitsWriter,
    }

    impl SpsBuilder {
        fn new() -> Self {
            Self {
                writer: crate::io::bits_writer::BitsWriter::new(
                    crate::io::bytes_writer::BytesWriter::default(),
                ),
            }
        }
