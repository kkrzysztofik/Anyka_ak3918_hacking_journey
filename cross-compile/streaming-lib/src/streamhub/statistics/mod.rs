...
mod tests {
    ...
    fn test_statistics_stream_get_publisher_clears_subscribers() {
        ...
        // Add a subscriber
        let sub_uuid = Uuid::new(crate::streamhub::utils::RandomDigitCount::Four);
        stream
            .subscribers
    ...
    fn test_statistics_stream_get_subscriber_retains_matching() {
        ...
        let sub1_uuid = Uuid::new(crate::streamhub::utils::RandomDigitCount::Four);
        let sub2_uuid = Uuid::new(crate::streamhub::utils::RandomDigitCount::Four);
        stream
            .subscribers
    ...
    fn test_statistics_stream_get_subscriber_no_match_returns_empty() {
        ...
        let non_existent = Uuid::new(crate::streamhub::utils::RandomDigitCount::Six);
    ...
    fn test_statistics_stream_query_by_uuid_no_match() {
        ...
        let random_uuid = Uuid::new(crate::streamhub::utils::RandomDigitCount::Six);
    ...
    fn test_statistic_subscriber_debug() {
        let uuid = Uuid::new(crate::streamhub::utils::RandomDigitCount::Four);
