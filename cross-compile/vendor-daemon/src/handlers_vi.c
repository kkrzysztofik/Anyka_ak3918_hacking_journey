...
/* CMD_VI_OPEN. Wire format: [i32 video_dev_type] = 4 bytes. */
...
/* CMD_VI_CLOSE. Wire format: [u64 handle] = 8 bytes. */
...
/* CMD_VI_GET_SENSOR_RESOLUTION. four i32 values. */
...
/* CMD_VI_SET_CHANNEL_ATTR. Wire format for video_channel_attr (packed, LE): */
...
/* CMD_VI_CAPTURE_ON. Wire format: [u64 handle] = 8 bytes. */
...
/* CMD_VI_CAPTURE_OFF. Wire format: [u64 handle] = 8 bytes. */
...
/* CMD_VI_SET_FLIP_MIRROR. Wire format: [u64 handle][u8 flip][u8 mirror] = 10 bytes. */
