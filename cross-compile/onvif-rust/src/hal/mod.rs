...
//! On ARM targets, the VendorIpc client communicates with vendor-daemon via Unix socket.
...
// Stub types for all builds (replaces generated bindings)
pub mod stubs {
...
// NOSONAR: Wildcard re-export of stub types is standard pattern.
